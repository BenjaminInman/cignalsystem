...
import ExitAnalyzer from "@/components/ExitAnalyzer";

export default function ExitAnalyzerPage() {
  ...
  return (
    <div className="pg">
      <div className="pg__head">
        <div className="pg__kick">WORKBENCH · EXIT STRATEGY</div>
        <h1>Exit Strategy Analyzer</h1>
        <p>You own it — should you sell now or refinance and hold? The market’s cycle read drives the call.</p>
      </div>
      ...
      <ExitAnalyzer mr={mr} scenario={scenario} marketName={marketName} />

      <style jsx>{`
        .pg { max-width:960px; margin:0 auto; padding:26px 16px 60px; color:#ECEDEF; font-family:Archivo,sans-serif; }
