...
export const INDICES = [
  ...
  { category: "Home Improvement", members: [
    ...
    { ticker: "WSM", name: "Williams-Sonoma", price: 172.45, chg: 1.5 },
  ]},
  { category: "Lenders", members: [
    { ticker: "RKT", name: "Rocket Companies", price: 14.20, chg: -2.3 },
    { ticker: "UWMC", name: "UWM Holdings", price: 6.05, chg: -1.4 },
    { ticker: "PFSI", name: "PennyMac Financial", price: 104.60, chg: 0.8 },
    { ticker: "COOP", name: "Mr. Cooper Group", price: 98.10, chg: 1.1 },
  ]},
