...
export const SUBGROUP_BY_NAME = {
  ...
  "Underemployment Rate (U-6)": "Labor Market",
  "Underemployment Gap (U-6 - U-3)": "Labor Market",
  "Labor Force Participation Rate": "Labor Market",
  "Prime-Age Participation (25-54)": "Labor Market",
  ...
  "PCE Price Index": "Growth & Output",
  "Core CPI": "Inflation",
  "Core PCE": "Growth & Output",
  "Core PPI": "Inflation",
...
export const ORDER_IN_GROUP = {
  ...
  // Headline labor first, then the slack measures that sit underneath it, then
  // JOLTS internals, then labor supply, then pay. U-6 and its gap follow U-3
  // directly because they are only legible against it: the gap is the distance
  // between the two, and reading it apart from the headline invites the mistake
  // of treating a widening gap as a rising unemployment rate.
  "Labor Market": [
    "Job Growth",
    "Unemployment Rate",
  ...
  "Growth & Output": ["Gross Domestic Product", "Real Consumer Spending", "Core PCE", "PCE Price Index"],
  // Headline immediately followed by its core, upstream to downstream:
  // producer prices, then consumer prices.
  Inflation: [
    "PPI (Final Demand)",
    "Core PPI",
    "CPI (All Urban)",
