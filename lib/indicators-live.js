...
export async function getLiveIndicators() {
  ...
  if (rr) {
    ...
    out["Market Rent Growth"] = { value: pct(rr.latest), unit: "ZORI, YoY", change: `${signed(d)}% MoM`, note: "Zillow Observed Rent Index — national market asking rents", tone: "neutral", trend: rr.trend, periods: rr.periods, live: true };
  }
