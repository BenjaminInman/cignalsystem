...
export async function getLiveIndicators() {
  ...
  const [ahe, pay, gdp, pce, umc, cpi, ff, dom, perm, vac, rent, ys, ic, cl, cap, un, abs, zrd, dsc, mig, fc, e2024, e2534, rd, cre, rentmf, hvn] = await Promise.all([
