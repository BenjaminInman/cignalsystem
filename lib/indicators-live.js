...
export async function getLiveIndicators() {
  ...
  const [ahe, aher, pay, gdp, pce, umc, cpi, ff, dom, perm, vac, rent, ys, ic, cl, cap, un, abs, zrd, dsc, mig, fc, e2024, e2534, rd, cre, rentmf, hvn, t2y, baa, hyo, sfr, mls, jo, jq] = await Promise.all([
