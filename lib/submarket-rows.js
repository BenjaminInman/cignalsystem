...
export function metroSignalRows(sig) {
  ...
  if (s.metroWages) {
    ...
    rows.push({
      ...
      goodUp: true, trend: s.metroWages.trend, periods: s.metroWages.periods, zeroBased: false,
  ...
  if (s.countyUnemp) {
    ...
    rows.push({
      ...
      goodUp: false, trend: s.countyUnemp.trend, periods: s.countyUnemp.periods, zeroBased: false,
