...
function socialRow() {
  ...
  const icons = list
    .map(
      ([k, url]) => `<td style="padding:0 7px;">
        <a href="${esc(url)}" style="text-decoration:none;">
          <img src="${SITE}/social/${k}.png" width="18" height="18" alt="${SOCIAL_LABEL[k] || k}" style="display:block;border:0;width:18px;height:18px;"/>
        </a></td>`
    )
    .join("");
  return `
    <tr><td align="center" style="padding:26px 0 0;">
      <p style="margin:0 0 12px;font-family:${MONO};font-size:9px;letter-spacing:.18em;color:${MUT};">FOLLOW THE SIGNAL</p>
      <table cellpadding="0" cellspacing="0" border="0" role="presentation" align="center"><tr>${icons}</tr></table>
    </td></tr>`;
}
    ...
    <table width="600" cellpadding="0" cellspacing="0" border="0" role="presentation" style="width:100%;max-width:600px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation"><tr>
              ...
              <td valign="top" style="padding:0;">
                ...
                <table cellpadding="0" cellspacing="0" border="0" role="presentation" style="margin-top:14px;">
                  <tr><td bgcolor="#1B1A14" style="background-color:#1B1A14;border:1px solid ${GOLD};border-radius:999px;padding:9px 16px;">
                    <a href="${SITE}/research?ask=${encodeURIComponent(daily ? "What do today's headlines mean for where we are in the cycle?" : "What did this week's news change about where we are in the cycle?")}" style="text-decoration:none;display:block;">
                      <table cellpadding="0" cellspacing="0" border="0" role="presentation"><tr>
                        <td valign="middle" style="padding:0 8px 0 0;line-height:0;">
                          <img src="${SITE}/email-canary.png" width="14" height="16" alt="" style="display:block;border:0;width:14px;height:16px;"/>
                        </td>
                        <td valign="middle" style="font-family:${MONO};font-size:10px;letter-spacing:.14em;color:${GOLD};font-weight:700;white-space:nowrap;">ASK CANARY</td>
                      </tr></table>
                    </a>
                  </td></tr>
                </table>
      ...
      <tr><td style="padding:24px 10px 0;">
        ...
        <p style="margin:0;font-family:${SANS};font-size:11px;line-height:1.75;color:${MUT};">
          ...
          <br/>Cignal System LLC &nbsp;·&nbsp; Offices: Nashville, TN / West Palm Beach, FL
        </p>
      </td></tr>
