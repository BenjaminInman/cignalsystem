  ...
  <tr><td align="center" style="padding:32px 14px 48px;">
    ...
    <table width="600" cellpadding="0" cellspacing="0" border="0" role="presentation" style="width:100%;max-width:600px;">
      ...
      <tr><td style="padding:0 4px 14px;">
        <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation">
          <tr>
            <td align="left" style="font-family:${MONO};font-size:11px;letter-spacing:.22em;color:${GOLD};">CIGNAL SYSTEM</td>
            <td align="right" style="font-family:${MONO};font-size:9px;letter-spacing:.16em;color:${MUT};">${chip}</td>
          </tr>
        </table>
      </td></tr>
