...
export const COPY = {
  ...
  // An LP does not operate anything — they deploy. "Tuned to where you operate"
  // was the single most audience-wrong line on the investor site.
  aboutTuned: "where you deploy",
  // Portfolio framing: an investor holds positions in deals, not properties they
  // run, and their source document is a sponsor report, not a rent roll.
  aboutPortfolio:
    "Track your positions against the live market read to see which holdings ride a tailwind and which are exposed to a turn. Auto-fill the numbers straight from a sponsor report or operating statement, with NOI, expenses, and cycle position in one place.",
