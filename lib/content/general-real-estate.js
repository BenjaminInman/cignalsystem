...
export const TOP_MARKETS = [
  { city: "Austin, TX", cbsa: "12420", score: 82, rent: "+3.8%", vac: "2.9", tone: "bull" },
  { city: "Nashville, TN", cbsa: "34980", score: 80, rent: "+3.5%", vac: "3.0", tone: "bull" },
  { city: "Tampa, FL", cbsa: "45300", score: 74, rent: "+2.9%", vac: "3.4", tone: "bull" },
  { city: "Denver, CO", cbsa: "19740", score: 68, rent: "+1.9%", vac: "3.6", tone: "neutral" },
  { city: "Seattle, WA", cbsa: "42660", score: 57, rent: "+1.1%", vac: "3.9", tone: "neutral" },
  { city: "Chicago, IL", cbsa: "16980", score: 47, rent: "-0.4%", vac: "4.6", tone: "bear" },
];
...
export const INDICATORS = [
  { cat: "PERFORMANCE", type: "TRAILING", name: "Home Value Index", value: "+1.2%", unit: "ZHVI, YoY", change: "+0.1% MoM", note: "Zillow national home values", tone: "neutral",
    measures: "National home-value appreciation (Zillow ZHVI). A coincident read on owner equity, refinancing capacity and for-sale conditions.",
  ...
  { cat: "DEMAND", type: "LEADING", name: "Days On Market (For-Sale Homes)", value: "52", unit: "median days", change: "+3 days MoM", note: "Realtor.com national median", tone: "bear",
...
export const MARKET_GROUPS = [
  {
    region: "SUN BELT",
    markets: [
      { city: "Austin, TX", cbsa: "12420", rent: "+3.8%", vac: "2.9", cap: "$540K", noi: "+4.2%", score: 82, tone: "bull" },
      { city: "Nashville, TN", cbsa: "34980", rent: "+3.5%", vac: "3.0", cap: "$470K", noi: "+3.8%", score: 80, tone: "bull" },
      { city: "Atlanta, GA", cbsa: "12060", rent: "+3.1%", vac: "3.2", cap: "$405K", noi: "+3.4%", score: 76, tone: "bull" },
      { city: "Tampa, FL", cbsa: "45300", rent: "+2.9%", vac: "3.4", cap: "$415K", noi: "+3.1%", score: 74, tone: "bull" },
      { city: "Dallas, TX", cbsa: "19100", rent: "+2.6%", vac: "3.5", cap: "$390K", noi: "+2.7%", score: 72, tone: "neutral" },
    ],
  },
  {
    region: "MOUNTAIN WEST",
    markets: [
      { city: "Salt Lake City, UT", cbsa: "41620", rent: "+2.4%", vac: "3.1", cap: "$540K", noi: "+2.6%", score: 71, tone: "bull" },
      { city: "Denver, CO", cbsa: "19740", rent: "+1.9%", vac: "3.6", cap: "$610K", noi: "+1.8%", score: 68, tone: "neutral" },
    ],
  },
  {
    region: "GATEWAY",
    markets: [
      { city: "New York, NY", cbsa: "35620", rent: "+1.4%", vac: "4.1", cap: "$760K", noi: "+1.0%", score: 60, tone: "neutral" },
      { city: "Seattle, WA", cbsa: "42660", rent: "+1.1%", vac: "3.9", cap: "$740K", noi: "+0.9%", score: 57, tone: "neutral" },
      { city: "Chicago, IL", cbsa: "16980", rent: "-0.4%", vac: "4.6", cap: "$340K", noi: "-1.2%", score: 47, tone: "bear" },
    ],
  },
];
export const FORECAST_MARKETS = [
  { city: "Austin, TX", cbsa: "12420", y1: "+3.6%", y3: "+10.4%", conf: 80, tone: "bull" },
  { city: "Nashville, TN", cbsa: "34980", y1: "+3.3%", y3: "+9.5%", conf: 78, tone: "bull" },
  { city: "Tampa, FL", cbsa: "45300", y1: "+2.7%", y3: "+7.6%", conf: 72, tone: "bull" },
  { city: "Denver, CO", cbsa: "19740", y1: "+1.8%", y3: "+5.2%", conf: 63, tone: "neutral" },
  { city: "Seattle, WA", cbsa: "42660", y1: "+1.1%", y3: "+3.4%", conf: 58, tone: "neutral" },
  { city: "Chicago, IL", cbsa: "16980", y1: "-0.3%", y3: "+1.2%", conf: 55, tone: "bear" },
];
