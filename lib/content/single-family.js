...
export const TICKER = [
  ...
  { label: "MEDIAN SALE PRICE", value: "$403K", delta: "+1.4%", dir: "up" },
  { label: "30Y MORTGAGE RATE", value: "6.50%", delta: "-12bps", dir: "up" },
  { label: "SF PERMITS", value: "871K", delta: "-3.1%", dir: "down" },
  { label: "SF STARTS", value: "895K", delta: "+1.8%", dir: "up" },
  { label: "SF COMPLETIONS", value: "964K", delta: "+1.5%", dir: "up" },
  { label: "MONTHS OF SUPPLY", value: "10.3", delta: "+0.4", dir: "down" },
  { label: "HOMEOWNERSHIP RATE", value: "65.3%", delta: "-0.2", dir: "down" },
];
...
export const LEADING_CARDS = [
  { cat: "SUPPLY", name: "Single-Family Permits", value: "871K", delta: "-3.1%", dir: "down", tone: "bear", note: "One-unit permits easing — pipeline thinning into 2027", series: down1 },
  { cat: "SUPPLY", name: "Months of Supply (New)", value: "10.3", delta: "+0.4", dir: "down", tone: "bear", note: "New-home inventory well above a balanced 6 months", series: down1 },
  { cat: "MACRO", name: "30Y Mortgage Rate", value: "6.50%", delta: "-12bps", dir: "up", tone: "neutral", note: "Off the highs but still the binding affordability constraint", series: up1 },
  { cat: "DEMAND", name: "New Home Sales", value: "-6.8%", delta: "-1.2%", dir: "down", tone: "bear", note: "Builders carrying inventory into a soft demand window", series: down1 },
];
...
export const TRAILING_CARDS = [
  ...
  { cat: "PERFORMANCE", name: "Home Prices (Case-Shiller)", value: "+0.8%", delta: "-0.3%", dir: "up", tone: "neutral", note: "Repeat-sales appreciation flattening toward zero", series: up1 },
  { cat: "CAPITAL", name: "Homeownership Rate", value: "65.3%", delta: "-0.2", dir: "down", tone: "neutral", note: "Drifting down as affordability pushes households to rent", series: down1 },
  { cat: "CAPITAL", name: "Mortgage Delinquency", value: "1.7%", delta: "+0.1", dir: "down", tone: "neutral", note: "Single-family delinquency low but no longer improving", series: up1 },
];
...
export const INDICATORS = [
  ...
  { cat: "SUPPLY", type: "LEADING", name: "Building Permits — Single-Family", value: "871K", unit: "annualized, 1 unit", change: "-3.1% YoY", note: "One-unit permits only", tone: "bear",
    ...
    impact: "Falling one-unit permits point to fewer single-family completions in 12–18 months, tightening future for-sale and SFR supply.",
    trend: [960, 942, 928, 915, 902, 894, 883, 876, 871] },
  { cat: "SUPPLY", type: "LEADING", name: "Single-Family Housing Starts", value: "895K", unit: "annualized, 1 unit", change: "+1.8% YoY", note: "HOUST1F, monthly since 1959", tone: "neutral",
    measures: "Ground broken on single-family homes. Sits between permits and completions in the supply pipeline.",
    impact: "Starts holding up while permits fall means builders are working through an existing pipeline rather than adding to it.",
    trend: [862, 869, 874, 878, 883, 887, 890, 893, 895] },
  { cat: "SUPPLY", type: "COINCIDENT", name: "Single-Family Completions", value: "964K", unit: "annualized, 1 unit", change: "+1.5% YoY", note: "Deliveries hitting the market now", tone: "bear",
  ...
  { cat: "DEMAND", type: "LEADING", name: "New Single-Family Home Sales", value: "-6.8%", unit: "YoY", change: "-1.2% MoM", note: "HSN1F, already single-family", tone: "bear",
  ...
  { cat: "SUPPLY", type: "LEADING", name: "Months of Supply (New Homes)", value: "10.3", unit: "months", change: "+0.4 MoM", note: "Balanced market is ~6 months", tone: "bear",
  ...
  { cat: "PERFORMANCE", type: "TRAILING", name: "Home Prices (Case-Shiller)", value: "+0.8%", unit: "national, YoY", change: "-0.3% MoM", note: "Repeat-sales, mix-controlled", tone: "neutral",
    ...
    impact: "Appreciation flattening toward zero — read alongside median sale price, which moves with mix as well as with price.",
    trend: [4.2, 3.6, 3.0, 2.5, 2.0, 1.6, 1.2, 1.0, 0.8] },
  { cat: "CAPITAL", type: "TRAILING", name: "Homeownership Rate", value: "65.3%", unit: "of households", change: "-0.2 QoQ", note: "Census, quarterly", tone: "neutral",
    ...
    impact: "A falling ownership rate moves households into rentals — headwind for for-sale demand, tailwind for SFR.",
    trend: [66.0, 65.9, 65.8, 65.7, 65.6, 65.5, 65.5, 65.4, 65.3] },
];
...
export const SIGNALS = [
  ...
  { tone: "bear", title: "Completions Above Starts Signals Supply Overhang", body: "Single-family completions are running at 964K against 895K starts. Deliveries exceeding new construction means inventory keeps building even as the pipeline thins — the classic late-cycle sequence.", tags: ["Supply", "National"], time: "7 hours ago", conf: 82 },
  ...
  { tone: "bull", title: "One-Unit Permits Falling Eases 2027 Supply Risk", body: "Single-family permits are down 3.1% YoY at 871K. Painful for builders now, but it thins the completion pipeline 12–18 months out and supports pricing for existing inventory.", tags: ["Supply", "National"], time: "Yesterday", conf: 78 },
  ...
  { tone: "bear", title: "Ownership Rate Drifting as Affordability Bites", body: "The homeownership rate has slipped to 65.3%. With the 30-year near 6.5% and prices flat rather than falling, the affordability math is pushing marginal buyers into the rental pool.", tags: ["Macro", "National"], time: "3 days ago", conf: 77 },
];
...
export const NEWS = [
  ...
  { id: 3, title: "One-unit permits fall again as builders pull back", source: "Cignal Newsdesk", date: "Jul 15, 2026", cat: "Supply", excerpt: "Single-family permits slipped to 871K annualized, thinning the completion pipeline into 2027." },
  ...
  { id: 5, title: "Homeownership rate slips as affordability pushes households to rent", source: "Cignal Newsdesk", date: "Jul 8, 2026", cat: "Macro", excerpt: "At 65.3%, the ownership rate keeps drifting down — a headwind for for-sale demand and a tailwind for single-family rentals." },
