...
export const ENGINE_METHOD_VERSION = "2026.08-national-v1";

export const COEFFICIENTS = {
  kRent: 0.055,          // rent sensitivity to momentum (calibrated: rent~slack elasticity)
  kVac: 0.012,           // vacancy sensitivity to supply (LOCAL param; not nationally identified)
  capBeta: 0.50,         // exit-cap sensitivity to 10Y change (literature-anchored)
  phaseSens: 0.010,      // exit-cap sensitivity to exit-phase momentum
  capBuffer: 0.0035,     // underwriting conservatism buffer
  demandWeights: { emp: 0.35, rentMom: 0.40, absorption: 0.25 },
};
