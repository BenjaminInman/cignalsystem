...
export const ENGINE_METHOD_VERSION = "2026.08-msapanel-v2-qoq";
...
export function runMarketRead(i, scenario = "base") {
  ...
  let phase;
  if (momY1 < 0 && momY2 > 0) phase = "Contraction → Recovery (turning up)";
  else if (momY1 < -0.15) phase = "Hypersupply → Contraction";
