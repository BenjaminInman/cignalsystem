...
export const VERTICALS = {
  ...
  "single-family": {
    ...
    label: "Single Family",
    system: "Cignal System",
    title: "Cignal System — Market Intelligence for Single-Family",
    description:
      "Cignal System surfaces the leading and trailing signals that move the single-family housing market — read the cycle before you buy, sell, or rent.",
    accent: "#F5B544",
    ready: true,
    // Single-family is a DATA-DISTINCT vertical, not a relabel: its own rent
    // series (Zillow SFR cut), its own supply signals (PERMIT1 / HOUST1F /
    // COMPU1USA rather than the all-units totals), and its own wheel. Several
    // series it shares with general real estate are already single-family by
    // construction -- Case-Shiller is repeat-sales SFR, HSN1F is new
    // single-family sales, and the delinquency series is single-family.
    blurb: "The housing cycle read for what it is — single-family signal intelligence for buyers, sellers, and rental investors.",
